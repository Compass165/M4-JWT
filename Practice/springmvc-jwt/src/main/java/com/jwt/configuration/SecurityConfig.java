...
import com.jwt.rest.CustomAccessDeniedHandler;
import com.jwt.rest.RestAuthenticationEntryPoint;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.inMemoryAuthentication()
                .withUser("kai").password("{noop}1").roles("ADMIN")
                .and()
                .withUser("sena").password("{noop}1").roles("USER");
    }
